            ...
            if record.isStart():
                ...
                try:
                    ...
                    if entry.type == "double":
                        entryValue = record.getDouble()
                    elif entry.type == "int64":
                        entryValue = record.getInteger()
                    elif entry.type == "string" or entry.type == "json":
                        entryValue = record.getString()
                    elif entry.type == "boolean":
                        entryValue = record.getBoolean()
                    elif entry.type == "boolean[]":
                        entryValue = record.getBooleanArray().tolist()
                        arr = record.getBooleanArray()
                    elif entry.type == "double[]":
                        entryValue = record.getDoubleArray().tolist()
                        arr = record.getDoubleArray()
                    elif entry.type == "float[]":
                        entryValue = record.getFloatArray().tolist()
                        arr = record.getFloatArray()
                    elif entry.type == "int64[]":
                        entryValue = record.getIntegerArray().tolist()
                        arr = record.getIntegerArray()
                    elif entry.type == "string[]":
                        entryValue = record.getStringArray()
